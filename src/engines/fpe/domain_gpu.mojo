...
comptime GPU_DOM_DTYPE = METAL_DTYPE if has_apple_gpu_accelerator() else CUDA_DTYPE
comptime GPU_DOM_VEC = METAL_VEC_LAYOUT if has_apple_gpu_accelerator() else CUDA_VEC_LAYOUT
comptime GPU_DOM_MAX_N = METAL_MAX_N if has_apple_gpu_accelerator() else CUDA_MAX_N
